...
extern unsigned int *p_aes_key_column(unsigned int *previous, unsigned char *key, unsigned int index, unsigned int const_s, unsigned int jump);
extern unsigned int *p_aes_key_special_column(unsigned int *previous, unsigned char *key, unsigned int index, unsigned int const_s, unsigned int jump);
extern struct o_aes *f_aes_new(struct o_aes *supplied, enum e_aes_block block, unsigned char *key, size_t size);
...
extern struct o_string *p_aes_padding(struct o_string *string, int local, size_t const_n);
extern unsigned int p_aes_mix_column(unsigned int box);
extern unsigned int p_aes_mix_column_inverse(unsigned int box);
extern struct o_string *p_aes_crypt(struct o_aes *object, struct o_string *string, int local);
extern struct o_string *p_aes_decrypt(struct o_aes *object, struct o_string *string, int local);
#endif
