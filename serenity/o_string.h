...
extern struct o_string *f_string_new(char *content, int constant, struct o_string *supplied);
...
extern char *p_string_string(struct o_object *object, char *data, int size);
#endif
